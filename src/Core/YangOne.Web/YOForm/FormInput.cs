...
namespace YangOne.Web.Form
{
    ...
    public interface IFormInput
    {
        ...
        IHtmlContent RenderControlSource(object dataSource, object formModel);
    ...
    public abstract class BaseFormInput<T, TValue> : IFormInput<T>
    {
        ...
        public abstract IHtmlContent RenderControlSource(object dataSource, object formModel);
    ...
    public class FormInput<T, TValue> : BaseFormInput<T, TValue> where T : class
    {
        ...
        public override IHtmlContent RenderControlSource(object dataSource, object formModel)
        {
            ...
            {
                var controlValue = GetValueFor(formModel);
