...
namespace YangOne.Web.Form
{
    ...
    public interface IFormSectionsOf<T> : IFormSections<IFormSection<T>>
    {
        ...
        IFormSection<T> AddTab(string name, string classes, Action<IFormRowsOf<T>> rowsBuilder);
    }
    ...
    public class FormSections<T> : List<IFormSection<T>>, IFormSectionsOf<T> where T : class
    {
        ...
        public IFormSection<T> AddTab(string name, string classes, Action<IFormRowsOf<T>> rowsBuilder)
        {
