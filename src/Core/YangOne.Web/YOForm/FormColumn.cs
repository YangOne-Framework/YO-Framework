...
namespace YangOne.Web.Form
{
    public interface IFormColumn
    {
        ...
        string Child1Class { get; set; }
        string Child2Class { get; set; }
        string Child3Class { get; set; }
    ...
    public abstract class BaseFormColumn<T> : IFormColumn<T>
    {
        ...
        public string Child1Class { get; set; }
        public string Child2Class { get; set; }
        public string Child3Class { get; set; }
