...
namespace YangOne.Localization
{
    ...
    public class DataAnnotationLocalizer : IStringLocalizer
    {
        ...
        public DataAnnotationLocalizer(ILocaleResourceProvider localeResourceProvider) : this(CultureInfo.CurrentUICulture, localeResourceProvider)
        {
            _localeResourceProvider = localeResourceProvider;
        }

        public DataAnnotationLocalizer(CultureInfo cultureInfo, ILocaleResourceProvider localeResourceProvider)
        {
        ...
        {
            return new DataAnnotationLocalizer(culture,_localeResourceProvider);
        }
