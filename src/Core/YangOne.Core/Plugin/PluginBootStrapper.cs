...
namespace YangOne.Plugin
{
    public class PluginBootStrapper : IBootstrapper
    {
        ...
        public PluginBootStrapper(IWebHostEnvironment hostingEnvironment, ILogger logger, IServiceCollection services)
        {
        ...
        private void BuildContainer()
        {
            try
            {
                ...
                //});
                _services.Configure<MvcRazorRuntimeCompilationOptions>(opts =>
opts.FileProviders.Add(pluginFileProvider)
);
