...
namespace YangOne.OTP
{
	...
	public class TimeCorrection
	{
		...
		/// </summary>
		private TimeCorrection() => timeCorrectionFactor = TimeSpan.FromSeconds(0);
		...
		public TimeCorrection(DateTime correctUtc) => timeCorrectionFactor = DateTime.UtcNow - correctUtc;
		...
		public TimeCorrection(DateTime correctTime, DateTime referenceTime) => timeCorrectionFactor = referenceTime - correctTime;
		...
		public DateTime GetCorrectedTime(DateTime referenceTime) => referenceTime - timeCorrectionFactor;
