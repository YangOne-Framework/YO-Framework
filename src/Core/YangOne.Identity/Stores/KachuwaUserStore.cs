...
namespace YangOne.Identity.Stores
{
    ...
    public class YOUserStore<TUser, TKey, TUserRole, TRoleClaim, TUserClaim, TUserLogin, TRole> :
        ...
        where TUser : YangOneIdentityUser<TKey, TUserClaim, TUserRole, TUserLogin>
        where TKey : IEquatable<TKey>
        where TUserRole : YangOneIdentityUserRole<TKey>
        where TRoleClaim : YangOneIdentityRoleClaim<TKey>
        where TUserClaim : YangOneIdentityUserClaim<TKey>
        where TUserLogin : YangOneIdentityUserLogin<TKey>
