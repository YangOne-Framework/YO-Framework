...
namespace YangOne.Data
{
    ...
    public class DbLogger : ILogger
    {
        ...
        public DbLogger(IWebHostEnvironment hostingEnvironment, ILoggerSetting loggerSetting)
        {
            _loggerSetting = loggerSetting;
            Basedir = Path.Combine(hostingEnvironment.ContentRootPath, "DbLogs"); 
            ...
            LogFilePath = Path.Combine(Basedir, CustomFileName + _todaysDate + ".log");
