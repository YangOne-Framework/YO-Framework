...
/// <summary>
/// Identity Web module metadata.
/// </summary>
public class IdentityWebModule : IModule
{
    public string Name { get; set; } = "YangOne.Identity.Web";
    ...
    public Assembly Assembly { get; set; } = typeof(IdentityWebModule).Assembly;
    ...
    {
        var version = typeof(IdentityWebModule).Assembly
