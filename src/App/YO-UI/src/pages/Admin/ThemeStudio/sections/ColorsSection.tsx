    ...
    >
      ...
      <Accordion title="Semantic Mappings" badge={String(Object.keys(config.tokens.semantic).length)} defaultOpen={false}>
        <div className="space-y-2">
          ...
          <SemanticAdder existing={Object.keys(config.tokens.semantic)} onAdd={(path) => setToken("semantic", path, { ref: primitivePaths[0], type: "color" })} />
        </div>
      </Accordion>
      ...
      <Accordion title="Component Color Tokens" badge={String(Object.keys(config.tokens.component).length)} defaultOpen={false}>
        <div className="space-y-2">
          ...
          <SemanticAdder
            ...
            onAdd={(path) => setToken("component", path, { ref: primitivePaths[0], type: "color" })}
          />
        </div>
      </Accordion>
    </SectionShell>
