...
namespace YangOne.Web.Components
{
    ...
    public class NotificationBarViewComponent : YangOneViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            try
            {
                ...
                var notifications = _notificationTempDataWrapper.Peek<IEnumerable<Notification.Notification>>(this.HttpContext.User.Identity.GetIdentityUserId().ToString());
