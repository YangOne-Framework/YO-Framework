...
//            IImportService importService,ILogger logger, SignInManager<IdentityUser> signInManager
//            )
//        {
...
//            //::TODO GETTING USER LISt
//            var model = await _appUserService.AppUserCrudService.GetListAsync();
//            return View(model);
//        }       
...
//        [Route("admin/user/changepassword/{userId}")]
//        [Route("admin/user/changepassword")]
//        [FriendlyName("Change User's Password")]
//        public async Task<IActionResult> ChangePassword([FromRoute]int userId = 0)
//        {
//            if (userId == 0)
//            {
//                userId = (int)User.Identity.GetIdentityUserId();
//            }
//            var user = await _appUserService.AppUserCrudService.GetAsync("Where IdentityUserId=@UserId",new{ UserId=userId });
//            return View(new ChangePasswordUserViewModel()
//            {
...
//        [Route("admin/user/changepassword")]
//        [FriendlyName("Save Change User's Password")]
//        [HttpPost]
...
//                    {
//                        var userViewModel = user.To<NewUser>();                       
...
//        [FriendlyName("Update User's Status")]
