...
namespace YandOne.Admin.Controllers
{
    ...
    public class PluginsController : BaseController
    {
        ...
        public PluginsController(IPluginService pluginService, IHostApplicationLifetime applicationLifetime,
        ...
        [HttpPost]
        public async Task<ActionResult> New(NewPluginDto model)
        {
        ...
        [HttpPost]
        public async Task<object> Install(NewPluginDto model)
        {
        ...
        [HttpPost]
        public async Task<object> UnInstall(NewPluginDto model)
        {
            var plugins = _plugins.ToList();
            var plugin = plugins.SingleOrDefault(e => e.SystemName == model.SystemName);
            bool status = false;
        ...
        public async Task<IActionResult> UpdateUsage(Plugin plugin)
        {
            try
            {
